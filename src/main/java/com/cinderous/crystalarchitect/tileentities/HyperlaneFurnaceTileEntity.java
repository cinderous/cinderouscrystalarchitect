...
import com.cinderous.crystalarchitect.blocks.HyperlaneFurnace;
...
public class HyperlaneFurnaceTileEntity  extends LockableLootTileEntity {
    ...
    public HyperlaneFurnaceTileEntity(TileEntityType<?> typeIn) {
        super(typeIn);
    }



    public HyperlaneFurnaceTileEntity() {
        this(RegistryHandler.HYPERLANE_FURNACE_TILE_ENTITY.get());
    }
...
//    }
    ...
    protected ITextComponent getDefaultName() {
        return new TranslationTextComponent("container.hyperlane_furnace");
    }

    @Override
    protected Container createMenu(int id, PlayerInventory player) {
        return new HyperlaneFurnaceContainer(id, player, this);
    }
    ...
    protected void onOpenOrClose() {
        ...
        if (block instanceof HyperlaneFurnace) {
    ...
    public static int getPlayersUsing(IBlockReader reader, BlockPos pos) {
        ...
        if (blockstate.hasTileEntity()) {
            ...
            if (tileentity instanceof HyperlaneFurnaceTileEntity) {
                return ((HyperlaneFurnaceTileEntity) tileentity).numPlayersUsing;
            }
        }
        return 0;
    }

    public static void swapContents(HyperlaneFurnaceTileEntity te, HyperlaneFurnaceTileEntity otherTe) {
