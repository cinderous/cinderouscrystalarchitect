...
public class HyperlaneChunkGenerator extends NoiseChunkGenerator<HyperlaneGenSettings> {
    ...
    public HyperlaneChunkGenerator(IWorld worldIn, BiomeProvider provider, HyperlaneGenSettings settingsIn) {
