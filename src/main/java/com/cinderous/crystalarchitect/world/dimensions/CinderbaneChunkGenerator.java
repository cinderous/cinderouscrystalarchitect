...
public class CinderbaneChunkGenerator extends NoiseChunkGenerator<CinderbaneGenSettings> {
    ...
    public CinderbaneChunkGenerator(IWorld worldIn, BiomeProvider provider, CinderbaneGenSettings settingsIn) {
