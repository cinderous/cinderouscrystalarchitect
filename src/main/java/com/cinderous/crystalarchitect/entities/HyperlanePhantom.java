package com.cinderous.crystalarchitect.entities;
...
public class HyperlanePhantom extends AnimalEntity {

    private EatGrassGoal eatGrassGoal;
    private int exampleTimer;

    public HyperlanePhantom(EntityType<? extends AnimalEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public static void registerPlacementTypes() {
        registerPlacementType(RegistryHandler.HYPERLANE_PHANTOM.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND);
    }

    @Override
    public AgeableEntity createChild(AgeableEntity ageable) {
        HyperlanePhantom entity = new HyperlanePhantom(RegistryHandler.HYPERLANE_PHANTOM.get(), this.world);
